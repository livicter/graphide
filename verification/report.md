...
| G2 | PASS | self-review graph has nodes, edges, and files | nodes=2552 edges=14884 files=62 |
| G3 | PASS | self-review graph includes Rust files | rs=374 |
| G4 | PASS | self-review Map altitude is a real community cut, not a lone START | bubbles=3743 altitude=308 names=crate::fixtures::demo-parent::src::sub::decode,crate::fixtures::demo-parent::src::bus::Bus,crate::fixtures::demo-parent::src::bus::encode,crate::fixtures::demo-parent::src::bus::events,crate::fixtures::demo-parent::src::bus::BroadcastChannel,crate::fixtures::demo::src::sub::decode,crate::fixtures::demo::src::bus::Bus,crate::fixtures::demo::src::bus::encode |
| G5 | PASS | self-review snapshot is this checkout, not the synthetic explorer fixture | nodes=2552 edges=14884 |
...
| shot:decisions.png | PASS | screenshot decisions.png is not a black frame | luma=0.951 1440x900 bytes=118915 |
...
| shot:registry.png | PASS | screenshot registry.png is not a black frame | luma=0.943 1440x900 bytes=91368 |
...
| shot:timeline.png | PASS | screenshot timeline.png is not a black frame | luma=0.949 1440x900 bytes=104846 |
...
| shot:map.png | PASS | screenshot map.png is not a black frame | luma=0.957 1440x900 bytes=175024 |
...
| shot:fit-reorg.png | PASS | screenshot fit-reorg.png is not a black frame | luma=0.957 1440x900 bytes=177938 |
...
| shot:night.png | PASS | screenshot night.png is not a black frame | luma=0.217 std=0.241 1440x900 bytes=153700 |
...
| shot:enter-bubble.png | PASS | screenshot enter-bubble.png is not a black frame | luma=0.963 1440x900 bytes=148928 |
...
| shot:ego.png | PASS | screenshot ego.png is not a black frame | luma=0.958 1440x900 bytes=183477 |
...
| shot:ask.png | PASS | screenshot ask.png is not a black frame | luma=0.948 1440x900 bytes=186943 |
...
| shot:keys.png | PASS | screenshot keys.png is not a black frame | luma=0.960 1440x900 bytes=175194 |
...
| shot:path-walk.png | PASS | screenshot path-walk.png is not a black frame | luma=0.959 1440x900 bytes=174131 |
...
| shot:preset-blueprint.png | PASS | screenshot preset-blueprint.png is not a black frame | luma=0.935 1440x900 bytes=175636 |
...
| shot:evidence.png | PASS | screenshot evidence.png is not a black frame | luma=0.962 1440x900 bytes=145749 |
...
| shot:coverage-mark.png | PASS | screenshot coverage-mark.png is not a black frame | luma=0.963 1440x900 bytes=142461 |
...
| shot:stamp-host.png | PASS | screenshot stamp-host.png is not a black frame | luma=0.962 1440x900 bytes=149839 |
| R1 | PASS | self-review desk loaded the derived snapshot (not synthetic fallback) | 2552 nodes · 14884 edges · 62 files · 84676ms · javascript@0.1.0,python@0.1.0,rust@0.1.0,typescript@0.1.0 |
| R2 | PASS | self-review desk mode is on after live snap | {"desk":true,"bright":true,"status":"2552 nodes · 14884 edges · 62 files · 84676ms · javascript@0.1.0,python@0.1.0,ru"} |
| R3 | PASS | self-review chrome shows this checkout's graph counts | 2552 nodes · 14884 edges · 62 files · 84676ms · javascript@0.1.0,python@0.1.0,rust@0.1.0,typescript@0.1.0 |
...
| shot:self-review.png | PASS | screenshot self-review.png is not a black frame | luma=0.964 1440x900 bytes=175559 |
...
| shot:delta.png | PASS | screenshot delta.png is not a black frame | luma=0.965 1440x900 bytes=85303 |
...
| shot:sequence.png | PASS | screenshot sequence.png is not a black frame | luma=0.962 1440x900 bytes=105204 |
...
| shot:dataflow.png | PASS | screenshot dataflow.png is not a black frame | luma=0.961 1440x900 bytes=123685 |
...
| shot:lifecycle.png | PASS | screenshot lifecycle.png is not a black frame | luma=0.959 1440x900 bytes=120058 |
...
| shot:lineage.png | PASS | screenshot lineage.png is not a black frame | luma=0.967 1440x900 bytes=130985 |
...
| shot:route.png | PASS | screenshot route.png is not a black frame | luma=0.959 1440x900 bytes=113116 |
...
| shot:lens.png | PASS | screenshot lens.png is not a black frame | luma=0.956 1440x900 bytes=115748 |
