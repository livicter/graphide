...
| shot:overview.png | PASS | screenshot overview.png is not a black frame | luma=0.959 1440x900 bytes=118560 |
...
| shot:map.png | PASS | screenshot map.png is not a black frame | luma=0.958 1440x900 bytes=173549 |
...
| X3 | PASS | Export SVG was saved | bytes=105757 |
...
| shot:preset-blueprint.png | PASS | screenshot preset-blueprint.png is not a black frame | luma=0.922 1440x900 bytes=155530 |
...
| shot:evidence.png | PASS | screenshot evidence.png is not a black frame | luma=0.954 1440x900 bytes=177218 |
...
| shot:stamp-host.png | PASS | screenshot stamp-host.png is not a black frame | luma=0.964 1440x900 bytes=158351 |
| R1 | PASS | self-review desk loaded the derived snapshot (not synthetic fallback) | 880 nodes · 4627 edges · 43 files · 3705ms · javascript@0.1.0,python@0.1.0,rust@0.1.0,typescript@0.1.0 |
| R2 | PASS | self-review desk mode is on after live snap | {"desk":true,"bright":true,"status":"880 nodes · 4627 edges · 43 files · 3705ms · javascript@0.1.0,python@0.1.0,rust@"} |
| R3 | PASS | self-review chrome shows this checkout's graph counts | 880 nodes · 4627 edges · 43 files · 3705ms · javascript@0.1.0,python@0.1.0,rust@0.1.0,typescript@0.1.0 |
...
| shot:self-review.png | PASS | screenshot self-review.png is not a black frame | luma=0.964 1440x900 bytes=185169 |
...
| shot:delta.png | PASS | screenshot delta.png is not a black frame | luma=0.958 1440x900 bytes=92103 |
...
| shot:sequence.png | PASS | screenshot sequence.png is not a black frame | luma=0.956 1440x900 bytes=100116 |
...
| shot:dataflow.png | PASS | screenshot dataflow.png is not a black frame | luma=0.955 1440x900 bytes=108200 |
...
| shot:lifecycle.png | PASS | screenshot lifecycle.png is not a black frame | luma=0.953 1440x900 bytes=105340 |
