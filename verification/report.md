...
| shot:overview.png | PASS | screenshot overview.png is not a black frame | luma=0.960 1440x900 bytes=91571 |
...
| X3 | PASS | Export SVG was saved | bytes=112303 |
...
| shot:preset-blueprint.png | PASS | screenshot preset-blueprint.png is not a black frame | luma=0.922 1440x900 bytes=123235 |
...
| shot:evidence.png | PASS | screenshot evidence.png is not a black frame | luma=0.964 1440x900 bytes=115900 |
...
| shot:stamp-host.png | PASS | screenshot stamp-host.png is not a black frame | luma=0.964 1440x900 bytes=122722 |
...
| shot:delta.png | PASS | screenshot delta.png is not a black frame | luma=0.967 1440x900 bytes=66226 |
...
| shot:sequence.png | PASS | screenshot sequence.png is not a black frame | luma=0.961 1440x900 bytes=81736 |
...
| shot:dataflow.png | PASS | screenshot dataflow.png is not a black frame | luma=0.963 1440x900 bytes=87880 |
...
| shot:lifecycle.png | PASS | screenshot lifecycle.png is not a black frame | luma=0.961 1440x900 bytes=83662 |
...
| shot:route.png | PASS | screenshot route.png is not a black frame | luma=0.958 1440x900 bytes=87514 |
...
| shot:lens.png | PASS | screenshot lens.png is not a black frame | luma=0.953 1440x900 bytes=90024 |
