...
Harness `/scripts/webview-harness.html?mode=explorer&probe=0` (chrome 17) then `/scripts/webview-harness.html?live=1&probe=0&require=1` (self-review of this checkout) then `/scripts/webview-harness.html?delta=1&probe=0&require=1&ws=delta` (Architecture Delta on fixtures/demo vs demo-parent) then `/scripts/webview-harness.html?sequence=1&probe=0&require=1&ws=sequence` (Sequence on fixtures/demo) served from `extension/`.
...
| G2 | PASS | self-review graph has nodes, edges, and files | nodes=769 edges=3682 files=41 |
| G3 | PASS | self-review graph includes Rust files | rs=345 |
| G4 | PASS | self-review Map altitude is a real community cut, not a lone START | bubbles=1010 altitude=155 names=crate::crates::graphide-cli::src::main::ProgressSink::new,crate::crates::graphide-cli::src::main::Cli,crate::crates::graphide-cli::src::main::Cmd,crate::crates::graphide-cli::src::main::ProgressSink,crate::crates::graphide-engine::src::cluster::cluster_with,crate::crates::graphide-engine::src::cluster::coarse_bubbles,crate::crates::graphide-engine::src::cluster::node_coarse_bubble,crate::crates::graphide-engine::src::coverage::changed_nodes_with_sources |
| G5 | PASS | self-review snapshot is this checkout, not the synthetic explorer fixture | nodes=769 edges=3682 |
...
| shot:overview.png | PASS | screenshot overview.png is not a black frame | luma=0.960 1440x900 bytes=116113 |
...
| shot:map.png | PASS | screenshot map.png is not a black frame | luma=0.960 1440x900 bytes=170971 |
...
| shot:evidence.png | PASS | screenshot evidence.png is not a black frame | luma=0.955 1440x900 bytes=174806 |
...
| shot:stamp-host.png | PASS | screenshot stamp-host.png is not a black frame | luma=0.964 1440x900 bytes=169685 |
| R1 | PASS | self-review desk loaded the derived snapshot (not synthetic fallback) | 769 nodes · 3682 edges · 41 files · 2692ms · javascript@0.1.0,python@0.1.0,rust@0.1.0,typescript@0.1.0 |
| R2 | PASS | self-review desk mode is on after live snap | {"desk":true,"bright":true,"status":"769 nodes · 3682 edges · 41 files · 2692ms · javascript@0.1.0,python@0.1.0,rust@"} |
| R3 | PASS | self-review chrome shows this checkout's graph counts | 769 nodes · 3682 edges · 41 files · 2692ms · javascript@0.1.0,python@0.1.0,rust@0.1.0,typescript@0.1.0 |
...
| shot:self-review.png | PASS | screenshot self-review.png is not a black frame | luma=0.967 1440x900 bytes=185376 |
...
| shot:delta.png | PASS | screenshot delta.png is not a black frame | luma=0.959 1440x900 bytes=89036 |
...
| shot:sequence.png | PASS | screenshot sequence.png is not a black frame | luma=0.957 1440x900 bytes=97187 |
