...
| G2 | PASS | self-review graph has nodes, edges, and files | nodes=868 edges=4547 files=43 |
| G3 | PASS | self-review graph includes Rust files | rs=374 |
| G4 | PASS | self-review Map altitude is a real community cut, not a lone START | bubbles=1156 altitude=167 names=crate::crates::graphide-cli::src::main::ProgressSink::new,crate::crates::graphide-cli::src::main::Cli,crate::crates::graphide-cli::src::main::Cmd,crate::crates::graphide-cli::src::main::ProgressSink,crate::crates::graphide-engine::src::cluster::cluster_with,crate::crates::graphide-engine::src::cluster::coarse_bubbles,crate::crates::graphide-engine::src::cluster::node_coarse_bubble,crate::crates::graphide-engine::src::coverage::changed_nodes_with_sources |
| G5 | PASS | self-review snapshot is this checkout, not the synthetic explorer fixture | nodes=868 edges=4547 |
...
| shot:overview.png | PASS | screenshot overview.png is not a black frame | luma=0.959 1440x900 bytes=117409 |
...
| shot:map.png | PASS | screenshot map.png is not a black frame | luma=0.959 1440x900 bytes=172407 |
...
| X3 | PASS | Export SVG was saved | bytes=100953 |
...
| shot:evidence.png | PASS | screenshot evidence.png is not a black frame | luma=0.956 1440x900 bytes=179068 |
...
| shot:stamp-host.png | PASS | screenshot stamp-host.png is not a black frame | luma=0.963 1440x900 bytes=171022 |
| R1 | PASS | self-review desk loaded the derived snapshot (not synthetic fallback) | 868 nodes · 4547 edges · 43 files · 3962ms · javascript@0.1.0,python@0.1.0,rust@0.1.0,typescript@0.1.0 |
| R2 | PASS | self-review desk mode is on after live snap | {"desk":true,"bright":true,"status":"868 nodes · 4547 edges · 43 files · 3962ms · javascript@0.1.0,python@0.1.0,rust@"} |
| R3 | PASS | self-review chrome shows this checkout's graph counts | 868 nodes · 4547 edges · 43 files · 3962ms · javascript@0.1.0,python@0.1.0,rust@0.1.0,typescript@0.1.0 |
...
| shot:self-review.png | PASS | screenshot self-review.png is not a black frame | luma=0.964 1440x900 bytes=183896 |
...
| shot:delta.png | PASS | screenshot delta.png is not a black frame | luma=0.958 1440x900 bytes=90651 |
...
| shot:sequence.png | PASS | screenshot sequence.png is not a black frame | luma=0.955 1440x900 bytes=98844 |
...
| shot:dataflow.png | PASS | screenshot dataflow.png is not a black frame | luma=0.955 1440x900 bytes=107071 |
...
| shot:lifecycle.png | PASS | screenshot lifecycle.png is not a black frame | luma=0.953 1440x900 bytes=104127 |
