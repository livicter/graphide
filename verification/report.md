...
| G2 | PASS | self-review graph has nodes, edges, and files | nodes=2550 edges=14757 files=62 |
| G3 | PASS | self-review graph includes Rust files | rs=374 |
| G4 | PASS | self-review Map altitude is a real community cut, not a lone START | bubbles=3766 altitude=308 names=crate::fixtures::demo-parent::src::sub::decode,crate::fixtures::demo-parent::src::bus::Bus,crate::fixtures::demo-parent::src::bus::flush,crate::fixtures::demo-parent::src::bus::events,crate::fixtures::demo-parent::src::bus::BroadcastChannel,crate::fixtures::demo::src::sub::decode,crate::fixtures::demo::src::bus::Bus,crate::fixtures::demo::src::bus::encode |
| G5 | PASS | self-review snapshot is this checkout, not the synthetic explorer fixture | nodes=2550 edges=14757 |
...
| shot:overview.png | PASS | screenshot overview.png is not a black frame | luma=0.958 1440x900 bytes=121178 |
...
| shot:registry.png | PASS | screenshot registry.png is not a black frame | luma=0.943 1440x900 bytes=91390 |
...
| shot:timeline.png | PASS | screenshot timeline.png is not a black frame | luma=0.949 1440x900 bytes=104839 |
...
| shot:enter-bubble.png | PASS | screenshot enter-bubble.png is not a black frame | luma=0.963 1440x900 bytes=146774 |
...
| shot:ego.png | PASS | screenshot ego.png is not a black frame | luma=0.958 1440x900 bytes=183739 |
...
| shot:search.png | PASS | screenshot search.png is not a black frame | luma=0.959 1440x900 bytes=183446 |
...
| X3 | PASS | Export SVG was saved | bytes=117747 |
...
| shot:preset-blueprint.png | PASS | screenshot preset-blueprint.png is not a black frame | luma=0.929 1440x900 bytes=181334 |
...
| shot:present.png | PASS | screenshot present.png is not a black frame | luma=0.927 1440x900 bytes=68118 |
...
| shot:stamp-host.png | PASS | screenshot stamp-host.png is not a black frame | luma=0.963 1440x900 bytes=149397 |
| R1 | PASS | self-review desk loaded the derived snapshot (not synthetic fallback) | 2550 nodes · 14757 edges · 62 files · 83900ms · javascript@0.1.0,python@0.1.0,rust@0.1.0,typescript@0.1.0 |
| R2 | PASS | self-review desk mode is on after live snap | {"desk":true,"bright":true,"status":"2550 nodes · 14757 edges · 62 files · 83900ms · javascript@0.1.0,python@0.1.0,ru"} |
| R3 | PASS | self-review chrome shows this checkout's graph counts | 2550 nodes · 14757 edges · 62 files · 83900ms · javascript@0.1.0,python@0.1.0,rust@0.1.0,typescript@0.1.0 |
...
| shot:self-review.png | PASS | screenshot self-review.png is not a black frame | luma=0.964 1440x900 bytes=175348 |
...
| shot:delta.png | PASS | screenshot delta.png is not a black frame | luma=0.965 1440x900 bytes=85203 |
...
| shot:sequence.png | PASS | screenshot sequence.png is not a black frame | luma=0.962 1440x900 bytes=105236 |
...
| shot:dataflow.png | PASS | screenshot dataflow.png is not a black frame | luma=0.961 1440x900 bytes=123729 |
...
| shot:lifecycle.png | PASS | screenshot lifecycle.png is not a black frame | luma=0.959 1440x900 bytes=120092 |
...
| shot:lineage.png | PASS | screenshot lineage.png is not a black frame | luma=0.967 1440x900 bytes=131019 |
...
| shot:route.png | PASS | screenshot route.png is not a black frame | luma=0.959 1440x900 bytes=113149 |
...
| shot:lens.png | PASS | screenshot lens.png is not a black frame | luma=0.956 1440x900 bytes=115780 |
