...
| G2 | PASS | self-review graph has nodes, edges, and files | nodes=2808 edges=16584 files=70 |
| G3 | PASS | self-review graph includes Rust files | rs=395 |
| G4 | PASS | self-review Map altitude is a real community cut, not a lone START | bubbles=4178 altitude=352 names=fixtures.ts.pkg.bus.Bus.publish,fixtures.js.pkg.bus.BroadcastChannel,fixtures.js.pkg.bus.Bus.publish,fixtures.js.pkg.bus.Bus,fixtures.python.pkg.bus.BroadcastChannel,fixtures.python.pkg.bus.Bus.publish,fixtures.python.pkg.bus.Bus,fixtures.python.pkg.bus.publish |
| G5 | PASS | self-review snapshot is this checkout, not the synthetic explorer fixture | nodes=2808 edges=16584 |
| AH0 | PASS | agent command has no stamp path |  |
| AH1 | PASS | fixture wait exits 0 when the focused cut is blocked | exit=0 {"focus":"boot","state":"blocked","status":"blocked","cuts":[{"kind":"flow","flow":"boot","label":"boot","state":"blocked"},{"kind":"program","index":0,"label":"bin main","state":"working"},{"kind":"flow","flow":"control-flow","label":"cont |
| AH2 | PASS | fixture wait exits 2 when the focused cut settled and is not blocked | exit=2 state=done |
| AH3 | PASS | a focused open cut is settled, not blocked | exit=2 state=working |
| AH4 | PASS | herd rows cover working, blocked, idle, and done | blocked,working,idle,done |
| AH5 | PASS | stamp flag is refused | agents never stamp usage: node scripts/agent-herd.mjs --root <dir> [--focus <flow>] [--wait] [--json] [--no-parent] [--parent <dir>] [--snap <file>] [--program <index>]   --wait  exit 0 when the focused cut is blocked; exit 2 when review settled and it is not   --snap  read a snapshot instead of spawning graphide review (fixture proof) |
| AH6 | PASS | graphide review on fixtures/demo reports a herd and a wait exit | exit=2 focus=data-subscription state=working cuts=2 |
| AH7 | PASS | agent wait did not write .graphide/stamps/ | absent |
...
| shot:overview.png | PASS | screenshot overview.png is not a black frame | luma=0.961 1440x900 bytes=124221 |
...
| shot:decisions.png | PASS | screenshot decisions.png is not a black frame | luma=0.954 1440x900 bytes=126448 |
...
| shot:unmatched-hint.png | PASS | screenshot unmatched-hint.png is not a black frame | luma=0.956 1440x900 bytes=130005 |
...
| shot:open-slice.png | PASS | screenshot open-slice.png is not a black frame | luma=0.965 1440x900 bytes=136814 |
...
| shot:registry.png | PASS | screenshot registry.png is not a black frame | luma=0.947 1440x900 bytes=99514 |
...
| shot:timeline.png | PASS | screenshot timeline.png is not a black frame | luma=0.955 1440x900 bytes=108311 |
...
| shot:uncovered-node.png | PASS | screenshot uncovered-node.png is not a black frame | luma=0.961 1440x900 bytes=115764 |
...
| shot:draft-hint.png | PASS | screenshot draft-hint.png is not a black frame | luma=0.961 1440x900 bytes=119090 |
...
| G4 | PASS | Narrow desk (720) graph bar still does not overlap | {"barH":156,"wsEgo":false,"wsKinds":false,"egoKinds":false,"wsLegend":false,"chipHits":0,"cardHits":0,"visible":12,"cards":12,"spanX":549} |
| G4b | PASS | Narrow desk (720) Map is a grid, not one overlapping column | {"visible":12,"cards":12,"cardHits":0,"spanX":549} |
...
| shot:map.png | PASS | screenshot map.png is not a black frame | luma=0.960 1440x900 bytes=173542 |
| HR1 | PASS | Herd rail lists cuts with working, blocked, and idle | {"open":true,"states":["blocked","working","working","idle","idle"],"blockedFlow":"boot","blockedKind":"flow","xy":0,"cards":12,"lod":"0","ws":"map"} |
| HR2 | PASS | Blocked herd row opens the pending decision | {"ws":"decisions","title":"UnmatchedHint · boot · MissingHit","outcome":"pending","flow":"hint:boot:UnmatchedHint · boot · MissingHit","xy":0,"herd":true,"posts":[]} |
| shot:herd-rail.png | PASS | screenshot herd-rail.png is not a black frame | luma=0.956 1440x900 bytes=131301 |
| HR3 | PASS | Herd step did not write .graphide/stamps/ | absent |
...
| AC3 | PASS | .workspaces is a pill rack with tinted Map .on | {"wsRadius":14,"mapOn":true,"tinted":true,"onBg":"rgba(0, 102, 215, 0.898)","onColor":"rgb(0, 122, 255)"} |
...
| shot:apple-chrome.png | PASS | screenshot apple-chrome.png is not a black frame | luma=0.954 1440x900 bytes=174683 |
...
| shot:apple-chrome-icons.png | PASS | screenshot apple-chrome-icons.png is not a black frame | luma=0.960 1440x900 bytes=176453 |
...
| shot:fit-reorg.png | PASS | screenshot fit-reorg.png is not a black frame | luma=0.960 1440x900 bytes=174382 |
| FR5 | PASS | Fit / Reorganize did not write .graphide/stamps/ | absent |
| Z1 | PASS | Zoom in (#zoomIn) raises percent / scale; Map stays community LOD | via=zoomIn before={"pct":53,"pctText":"53% · overview","k":0.5291313559322034,"kTf":0.529131,"cards":12,"visible":12,"xy":0,"comm":0,"ws":"map","zoomIn":true,"zoomOut":true} after={"pct":63,"pctText":"63% · overview","k":0.634957627118644,"kTf":0.634958,"cards":12,"visible":12,"xy":0,"comm":0,"ws":"map","zoomIn":true,"zoomOut":true} |
| shot:zoom.png | PASS | screenshot zoom.png is not a black frame | luma=0.960 1440x900 bytes=179444 |
| Z2 | PASS | Zoom out (#zoomOut) lowers percent / scale; Map stays community LOD | via=zoomOut in={"pct":63,"pctText":"63% · overview","k":0.634957627118644,"kTf":0.634958,"cards":12,"visible":12,"xy":0,"comm":0,"ws":"map","zoomIn":true,"zoomOut":true} out={"pct":53,"pctText":"53% · overview","k":0.5291313559322034,"cards":12,"visible":12,"xy":0,"comm":0,"stampPosts":0,"skipPosts":0,"ws":"map"} |
| Z3 | PASS | Zoom in / out does not post stamp / skip | {"stampPosts":0,"skipPosts":0} |
| Z4 | PASS | Zoom did not write .graphide/stamps/ | absent |
| RC0 | PASS | Map paints communities before recycle | {"cards":12,"xy":0,"comm":0,"lod":"0","k":0.5291313559322034,"ws":"map"} |
| RC1 | PASS | Re-select Map recycles the same .stage / .viewport (keepCam) | {"sameStage":true,"sameVp":true,"cards":12,"xy":0,"comm":0,"lod":"0","k":0.634957627118644,"wantK":0.634957627118644,"ws":"map"} |
| RC2 | PASS | Preview / patch recycles Map stage and keeps the camera | {"sameStage":true,"sameVp":true,"cards":12,"xy":0,"comm":0,"lod":"0","k":0.5308563888152972,"stampPosts":0,"skipPosts":0,"ws":"map"} |
| RC3 | PASS | Recycle does not post stamp / skip | {"stampPosts":0,"skipPosts":0} |
| shot:canvas-recycle.png | PASS | screenshot canvas-recycle.png is not a black frame | luma=0.958 1440x900 bytes=174222 |
| RC4 | PASS | Canvas recycle did not write .graphide/stamps/ | absent |
| DA0 | PASS | Map paints communities before a coverage-only patch | {"cards":12,"xy":0,"comm":0,"lod":"0","k":0.5291313559322034,"cov":"2 left0 stamped1 skipped1 brokenCoverage 1123 changed · 1123 uncovered · Review 0 stamped · 1 skipped · 1 broken · 2 pending · e.g. ScreenshotFormat, ext, as_str +1120stamp broken boot · +1 / −0unmatched solarsim::MissingHit in boot","ws":"map"} |
| DA1 | PASS | Coverage/findings-only patch keeps the same .stage / .viewport and camera | {"sameStage":true,"sameVp":true,"cards":12,"xy":0,"comm":0,"lod":"0","k":0.5291313559322034,"wantK":0.5291313559322034,"cov":"2 left0 stamped1 skipped1 brokenCoverage 1 changed · 3 uncovered · Review 0 stamped · 1 skipped · 1 broken · 2 pending · e.g. Body, SelectedEntity, PilotModeunmatched solarsim::MissingHit in bootunmatched graphide::OnAnalysisDelta in boot","stampPosts":0,"skipPosts":0,"ws":"map"} |
...
| shot:delta-onanalysis.png | PASS | screenshot delta-onanalysis.png is not a black frame | luma=0.960 1440x900 bytes=171919 |
...
| shot:map-offview.png | PASS | screenshot map-offview.png is not a black frame | luma=0.960 1440x900 bytes=180687 |
...
| shot:panel-timeout.png | PASS | screenshot panel-timeout.png is not a black frame | luma=0.960 1440x900 bytes=168143 |
| PT2 | PASS | Zoom handler fires after shed without waiting on the full findings list | {"enabled":true,"via":"zoomIn","k0":0.5291313559322034,"k":0.634957627118644,"pct0":"53% · overview","pct":"63% · overview","sameStage":true,"sameVp":true,"shed":"shed","lod":"0","xy":0,"comm":0,"cards":12,"ws":"map"} |
...
| shot:flow-tabs.png | PASS | screenshot flow-tabs.png is not a black frame | luma=0.964 1440x900 bytes=138782 |
...
| shot:slice-grey.png | PASS | screenshot slice-grey.png is not a black frame | luma=0.964 1440x900 bytes=137276 |
...
| shot:slice-runs.png | PASS | screenshot slice-runs.png is not a black frame | luma=0.965 1440x900 bytes=136584 |
...
| SE0 | PASS | Slice paints Steiner XYFlow before recycle | {"ws":"slice","slice":29,"enter":0,"cards":0,"k":0.37874834629628923} |
| SE1 | PASS | Re-select Slice recycles the same .stage / .viewport (keepCam) | {"sameStage":true,"sameVp":true,"slice":29,"enter":0,"k":0.4381578947368421,"wantK":0.4381578947368421,"ws":"slice"} |
| SE2 | PASS | Patch recycles Slice stage and keeps the camera | {"sameStage":true,"sameVp":true,"slice":29,"k":0.4381578947368421,"wantK":0.4381578947368421,"ws":"slice"} |
...
| shot:slice-enter-recycle.png | PASS | screenshot slice-enter-recycle.png is not a black frame | luma=0.963 1440x900 bytes=150770 |
...
| shot:stamp-recheck.png | PASS | screenshot stamp-recheck.png is not a black frame | luma=0.965 1440x900 bytes=136695 |
...
| ST6 | PASS | Stamp recheck overlay returns Map to community LOD (xy=0) | {"ws":"map","xy":0,"cards":12,"comm":0} |
...
| shot:progress.png | PASS | screenshot progress.png is not a black frame | luma=0.957 1440x900 bytes=168951 |
...
| shot:cancel-review.png | PASS | screenshot cancel-review.png is not a black frame | luma=0.959 1440x900 bytes=170266 |
...
| shot:night.png | PASS | screenshot night.png is not a black frame | luma=0.211 std=0.234 1440x900 bytes=146025 |
| N3 | PASS | Night Map is dark vs day map.png | night=0.211 day=0.960 std=0.234 |
...
| shot:enter-bubble.png | PASS | screenshot enter-bubble.png is not a black frame | luma=0.963 1440x900 bytes=157492 |
...
| shot:ego.png | PASS | screenshot ego.png is not a black frame | luma=0.959 1440x900 bytes=175617 |
...
| shot:search.png | PASS | screenshot search.png is not a black frame | luma=0.960 1440x900 bytes=175602 |
...
| shot:kind-filters.png | PASS | screenshot kind-filters.png is not a black frame | luma=0.964 1440x900 bytes=156557 |
...
| shot:ask.png | PASS | screenshot ask.png is not a black frame | luma=0.952 1440x900 bytes=184994 |
...
| shot:keys.png | PASS | screenshot keys.png is not a black frame | luma=0.962 1440x900 bytes=175937 |
...
| shot:path-walk.png | PASS | screenshot path-walk.png is not a black frame | luma=0.964 1440x900 bytes=174905 |
...
| X2 | PASS | Export PNG was saved and is not a black frame | luma=0.945 std=0.049 1888x520 bytes=91875 |
| X3 | PASS | Export SVG was saved | bytes=133816 |
...
| shot:preset-blueprint.png | PASS | screenshot preset-blueprint.png is not a black frame | luma=0.942 1440x900 bytes=179901 |
...
| shot:present.png | PASS | screenshot present.png is not a black frame | luma=0.925 1440x900 bytes=76520 |
...
| shot:evidence.png | PASS | screenshot evidence.png is not a black frame | luma=0.963 1440x900 bytes=161969 |
...
| shot:coverage-mark.png | PASS | screenshot coverage-mark.png is not a black frame | luma=0.965 1440x900 bytes=159367 |
...
| shot:hop-card.png | PASS | screenshot hop-card.png is not a black frame | luma=0.964 1440x900 bytes=166466 |
...
| shot:stamp-host.png | PASS | screenshot stamp-host.png is not a black frame | luma=0.962 1440x900 bytes=166448 |
| LR1 | PASS | Webview recreate restores workspace, program chip, Find, focus, and Map pins | {"before":{"ws":"map","program":"0","q":"rend","focusOn":true,"left":940.151,"top":328.619,"lod":"0"},"after":{"ws":"map","program":"0","q":"rend","focusOn":true,"left":940.129,"top":328.5,"moved":true,"cards":12,"xy":0,"lod":"0","herd":true},"seed":{"focus":"n0","q":"rend","id":"b-integration","left":482,"top":144},"posts":[]} |
| shot:layout-resume.png | PASS | screenshot layout-resume.png is not a black frame | luma=0.961 1440x900 bytes=168693 |
| LR2 | PASS | Layout resume did not write .graphide/stamps/ | absent |
| R1 | PASS | self-review desk loaded the derived snapshot (not synthetic fallback) | 2808 nodes · 16584 edges · 70 files · 94621ms · javascript@0.1.0,python@0.1.0,rust@0.1.0,typescript@0.1.0 |
| R2 | PASS | self-review desk mode is on after live snap | {"desk":true,"bright":true,"status":"2808 nodes · 16584 edges · 70 files · 94621ms · javascript@0.1.0,python@0.1.0,ru"} |
| R3 | PASS | self-review chrome shows this checkout's graph counts | 2808 nodes · 16584 edges · 70 files · 94621ms · javascript@0.1.0,python@0.1.0,rust@0.1.0,typescript@0.1.0 |
...
| shot:self-review.png | PASS | screenshot self-review.png is not a black frame | luma=0.961 1440x900 bytes=195875 |
...
| HR4 | PASS | self-review herd lists a cut per program | programs=12 |
...
| shot:program-chips.png | PASS | screenshot program-chips.png is not a black frame | luma=0.961 1440x900 bytes=196734 |
...
| shot:all-programs.png | PASS | screenshot all-programs.png is not a black frame | luma=0.961 1440x900 bytes=195878 |
...
| D4 | PASS | Delta lists added crate::bus::sneaky_helper | = stablecommunity · bubble 1 · crate::sub::decodekept bubble 1 \| = stablecommunity · bubble 3 · crate::bus::BroadcastChannelkept bubble 3 \| = stablecommunity · bubble 4 · crate::bus::eventskept bubble 4 \| ~ relabelcommunity · bubble 2 · crate::bus::flushbubble 2 · crate::bus::encode → crate::bus::flush |
...
| shot:delta.png | PASS | screenshot delta.png is not a black frame | luma=0.964 1440x900 bytes=118199 |
...
| shot:sticky-clusters.png | PASS | screenshot sticky-clusters.png is not a black frame | luma=0.964 1440x900 bytes=111731 |
...
| shot:delta-sticky-views.png | PASS | screenshot delta-sticky-views.png is not a black frame | luma=0.964 1440x900 bytes=111632 |
...
| shot:proposed-uncovered.png | PASS | screenshot proposed-uncovered.png is not a black frame | luma=0.968 1440x900 bytes=109527 |
...
| shot:sequence.png | PASS | screenshot sequence.png is not a black frame | luma=0.961 1440x900 bytes=112464 |
...
| shot:flow-hints.png | PASS | screenshot flow-hints.png is not a black frame | luma=0.962 1440x900 bytes=98417 |
...
| shot:dataflow.png | PASS | screenshot dataflow.png is not a black frame | luma=0.961 1440x900 bytes=125912 |
...
| shot:lifecycle.png | PASS | screenshot lifecycle.png is not a black frame | luma=0.958 1440x900 bytes=120349 |
...
| Y3 | PASS | Lineage focus node is present | crate::bus::events |
| Y4 | PASS | Lineage XYFlow nodes > 1 on a Calls fixture (capped, not the raw IR) | xy=3 hops=2 |
| Y4b | PASS | Lineage XYFlow nodes expose data-shape | n=3 shapes=fn,endpoint |
| Y5 | PASS | Lineage has upstream and downstream when the fixture has both | up=1 down=1 via=seed fqn=crate::bus::events |
...
| SG3 | PASS | Find filters Lineage hops / nodes | {"q":"events","before":2,"hops":2,"dim":2,"hit":1,"nodes":3} |
...
| shot:lineage.png | PASS | screenshot lineage.png is not a black frame | luma=0.965 1440x900 bytes=137119 |
...
| shot:route.png | PASS | screenshot route.png is not a black frame | luma=0.959 1440x900 bytes=120409 |
...
| shot:lens.png | PASS | screenshot lens.png is not a black frame | luma=0.956 1440x900 bytes=123190 |
...
| shot:python-desk.png | PASS | screenshot python-desk.png is not a black frame | luma=0.962 1440x900 bytes=99569 |
| PY6 | PASS | Python Map is community LOD (cards, xy=0, not a lone START) | cards=5 xy=0 names=decode,events,flush,BroadcastChannel,publish |
| PY7 | PASS | Python desk step did not write .graphide/stamps/ | absent |
| JS0 | PASS | javascript fixture snap is javascript@ with a real graph | plugin=javascript@0.1.0 nodes=9 edges=9 files=2 js=9 |
| JS0b | PASS | javascript fixture snap has named flow data-subscription with a Steiner tree | hits=pkg.sub.subscribe,pkg.bus.events tree=2n/1e |
| JS0c | PASS | javascript fixture snap has a flow with Source and Sink hops | data-subscription:3n/2h/store+sink+source |
| JS1 | PASS | javascript desk loaded the fixtures/js snap | dataflow javascript@0.1.0 |
| JS2 | PASS | JavaScript Data-flow workspace is active | dataflow |
...
| shot:js-desk.png | PASS | screenshot js-desk.png is not a black frame | luma=0.962 1440x900 bytes=99461 |
...
| TS0c | PASS | typescript fixture snap has a flow with Source and Sink hops | data-subscription:3n/2h/store+sink+source |
| TS1 | PASS | typescript desk loaded the fixtures/ts snap | dataflow typescript@0.1.0 |
| TS2 | PASS | TypeScript Data-flow workspace is active | dataflow |
...
| shot:ts-desk.png | PASS | screenshot ts-desk.png is not a black frame | luma=0.962 1440x900 bytes=99409 |
