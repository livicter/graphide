...
| shot:overview.png | PASS | screenshot overview.png is not a black frame | luma=0.958 1440x900 bytes=92749 |
...
| G1 | PASS | Graph bar controls do not overlap | {"barH":100,"wsEgo":false,"wsPath":false,"wsKinds":false,"egoKinds":false,"wsLegend":false,"kindsLegend":false,"chipHits":0,"cardHits":0,"chips":1,"titleInStage":true,"titleHitsCard":false,"cards":12,"visible":12,"titleInsideViewport":false} |
| G2 | PASS | Map caption sits outside the camera and not on a community card | {"barH":100,"wsEgo":false,"wsPath":false,"wsKinds":false,"egoKinds":false,"wsLegend":false,"kindsLegend":false,"chipHits":0,"cardHits":0,"chips":1,"titleInStage":true,"titleHitsCard":false,"cards":12,"visible":12,"titleInsideViewport":false} |
...
| G4 | PASS | Narrow desk (720) graph bar still does not overlap | {"barH":133,"wsEgo":false,"wsKinds":false,"egoKinds":false,"wsLegend":false,"chipHits":0,"cardHits":0,"visible":12,"cards":12,"spanX":544} |
...
| shot:map.png | PASS | screenshot map.png is not a black frame | luma=0.957 1440x900 bytes=138467 |
| X1 | PASS | Export menu opens from #exportBtn | {"btn":true,"menu":true,"png":true,"svg":true,"share":true} |
| X2 | PASS | Export PNG was saved and is not a black frame | luma=0.948 std=0.037 1888x539 bytes=74080 |
| X3 | PASS | Export SVG was saved | bytes=116987 |
...
| shot:preset-blueprint.png | PASS | screenshot preset-blueprint.png is not a black frame | luma=0.922 1440x900 bytes=121111 |
...
| shot:present.png | PASS | screenshot present.png is not a black frame | luma=0.926 1440x900 bytes=60527 |
...
| shot:evidence.png | PASS | screenshot evidence.png is not a black frame | luma=0.963 1440x900 bytes=114989 |
...
| shot:stamp-host.png | PASS | screenshot stamp-host.png is not a black frame | luma=0.964 1440x900 bytes=119574 |
...
| shot:self-review.png | PASS | screenshot self-review.png is not a black frame | luma=0.963 1440x900 bytes=146204 |
...
| shot:delta.png | PASS | screenshot delta.png is not a black frame | luma=0.966 1440x900 bytes=64772 |
...
| shot:sequence.png | PASS | screenshot sequence.png is not a black frame | luma=0.964 1440x900 bytes=83098 |
...
| shot:dataflow.png | PASS | screenshot dataflow.png is not a black frame | luma=0.962 1440x900 bytes=98424 |
...
| shot:lifecycle.png | PASS | screenshot lifecycle.png is not a black frame | luma=0.960 1440x900 bytes=89688 |
...
| shot:lineage.png | PASS | screenshot lineage.png is not a black frame | luma=0.968 1440x900 bytes=111941 |
...
| shot:route.png | PASS | screenshot route.png is not a black frame | luma=0.960 1440x900 bytes=88570 |
...
| shot:lens.png | PASS | screenshot lens.png is not a black frame | luma=0.957 1440x900 bytes=91627 |
