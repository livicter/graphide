...
| shot:overview.png | PASS | screenshot overview.png is not a black frame | luma=0.961 1440x900 bytes=124642 |
...
| shot:decisions.png | PASS | screenshot decisions.png is not a black frame | luma=0.954 1440x900 bytes=124470 |
...
| shot:unmatched-hint.png | PASS | screenshot unmatched-hint.png is not a black frame | luma=0.956 1440x900 bytes=130124 |
...
| shot:open-slice.png | PASS | screenshot open-slice.png is not a black frame | luma=0.965 1440x900 bytes=136651 |
...
| shot:timeline.png | PASS | screenshot timeline.png is not a black frame | luma=0.953 1440x900 bytes=108470 |
...
| shot:uncovered-node.png | PASS | screenshot uncovered-node.png is not a black frame | luma=0.961 1440x900 bytes=116016 |
...
| shot:draft-hint.png | PASS | screenshot draft-hint.png is not a black frame | luma=0.961 1440x900 bytes=119088 |
...
| shot:map.png | PASS | screenshot map.png is not a black frame | luma=0.960 1440x900 bytes=174213 |
...
| shot:apple-chrome.png | PASS | screenshot apple-chrome.png is not a black frame | luma=0.955 1440x900 bytes=176563 |
...
| shot:apple-chrome-icons.png | PASS | screenshot apple-chrome-icons.png is not a black frame | luma=0.960 1440x900 bytes=176087 |
...
| shot:fit-reorg.png | PASS | screenshot fit-reorg.png is not a black frame | luma=0.960 1440x900 bytes=174212 |
...
| shot:zoom.png | PASS | screenshot zoom.png is not a black frame | luma=0.960 1440x900 bytes=179209 |
...
| shot:canvas-recycle.png | PASS | screenshot canvas-recycle.png is not a black frame | luma=0.957 1440x900 bytes=171076 |
| RC4 | PASS | Canvas recycle did not write .graphide/stamps/ | absent |
| DA0 | PASS | Map paints communities before a coverage-only patch | {"cards":12,"xy":0,"comm":0,"lod":"0","k":0.5293233580930421,"cov":"2 left0 stamped1 skipped1 brokenCoverage 1123 changed · 1123 uncovered · Review 0 stamped · 1 skipped · 1 broken · 2 pending · e.g. ScreenshotFormat, ext, as_str +1120stamp broken boot · +1 / −0unmatched solarsim::MissingHit in boot","ws":"map"} |
...
| shot:delta-onanalysis.png | PASS | screenshot delta-onanalysis.png is not a black frame | luma=0.960 1440x900 bytes=171753 |
...
| shot:map-offview.png | PASS | screenshot map-offview.png is not a black frame | luma=0.959 1440x900 bytes=180582 |
...
| shot:panel-timeout.png | PASS | screenshot panel-timeout.png is not a black frame | luma=0.960 1440x900 bytes=167192 |
...
| shot:flow-tabs.png | PASS | screenshot flow-tabs.png is not a black frame | luma=0.964 1440x900 bytes=139038 |
...
| shot:slice-grey.png | PASS | screenshot slice-grey.png is not a black frame | luma=0.964 1440x900 bytes=137463 |
...
| shot:slice-runs.png | PASS | screenshot slice-runs.png is not a black frame | luma=0.965 1440x900 bytes=136580 |
...
| shot:slice-enter-recycle.png | PASS | screenshot slice-enter-recycle.png is not a black frame | luma=0.963 1440x900 bytes=150824 |
...
| shot:progress.png | PASS | screenshot progress.png is not a black frame | luma=0.957 1440x900 bytes=168761 |
...
| shot:cancel-review.png | PASS | screenshot cancel-review.png is not a black frame | luma=0.959 1440x900 bytes=171965 |
...
| shot:night.png | PASS | screenshot night.png is not a black frame | luma=0.211 std=0.234 1440x900 bytes=145924 |
...
| shot:enter-bubble.png | PASS | screenshot enter-bubble.png is not a black frame | luma=0.963 1440x900 bytes=157488 |
...
| shot:kind-filters.png | PASS | screenshot kind-filters.png is not a black frame | luma=0.964 1440x900 bytes=156554 |
...
| shot:ask.png | PASS | screenshot ask.png is not a black frame | luma=0.952 1440x900 bytes=184804 |
...
| shot:keys.png | PASS | screenshot keys.png is not a black frame | luma=0.962 1440x900 bytes=175841 |
...
| shot:path-walk.png | PASS | screenshot path-walk.png is not a black frame | luma=0.964 1440x900 bytes=174505 |
...
| shot:preset-blueprint.png | PASS | screenshot preset-blueprint.png is not a black frame | luma=0.942 1440x900 bytes=179848 |
...
| shot:present.png | PASS | screenshot present.png is not a black frame | luma=0.926 1440x900 bytes=70929 |
...
| shot:evidence.png | PASS | screenshot evidence.png is not a black frame | luma=0.964 1440x900 bytes=162503 |
...
| shot:coverage-mark.png | PASS | screenshot coverage-mark.png is not a black frame | luma=0.965 1440x900 bytes=159432 |
...
| shot:hop-card.png | PASS | screenshot hop-card.png is not a black frame | luma=0.964 1440x900 bytes=166573 |
...
| shot:stamp-host.png | PASS | screenshot stamp-host.png is not a black frame | luma=0.962 1440x900 bytes=165936 |
| R1 | PASS | self-review desk loaded the derived snapshot (not synthetic fallback) | 2750 nodes · 16292 edges · 68 files · 92974ms · javascript@0.1.0,python@0.1.0,rust@0.1.0,typescript@0.1.0 |
| R2 | PASS | self-review desk mode is on after live snap | {"desk":true,"bright":true,"status":"2750 nodes · 16292 edges · 68 files · 92974ms · javascript@0.1.0,python@0.1.0,ru"} |
| R3 | PASS | self-review chrome shows this checkout's graph counts | 2750 nodes · 16292 edges · 68 files · 92974ms · javascript@0.1.0,python@0.1.0,rust@0.1.0,typescript@0.1.0 |
...
| shot:self-review.png | PASS | screenshot self-review.png is not a black frame | luma=0.961 1440x900 bytes=196465 |
...
| shot:program-chips.png | PASS | screenshot program-chips.png is not a black frame | luma=0.961 1440x900 bytes=197317 |
...
| shot:all-programs.png | PASS | screenshot all-programs.png is not a black frame | luma=0.961 1440x900 bytes=196454 |
...
| shot:delta.png | PASS | screenshot delta.png is not a black frame | luma=0.964 1440x900 bytes=118161 |
...
| shot:sticky-clusters.png | PASS | screenshot sticky-clusters.png is not a black frame | luma=0.964 1440x900 bytes=111692 |
...
| shot:delta-sticky-views.png | PASS | screenshot delta-sticky-views.png is not a black frame | luma=0.964 1440x900 bytes=111594 |
...
| shot:proposed-uncovered.png | PASS | screenshot proposed-uncovered.png is not a black frame | luma=0.968 1440x900 bytes=109491 |
...
| shot:sequence.png | PASS | screenshot sequence.png is not a black frame | luma=0.961 1440x900 bytes=112513 |
...
| shot:flow-hints.png | PASS | screenshot flow-hints.png is not a black frame | luma=0.962 1440x900 bytes=98350 |
...
| shot:dataflow.png | PASS | screenshot dataflow.png is not a black frame | luma=0.961 1440x900 bytes=125840 |
...
| shot:lineage.png | PASS | screenshot lineage.png is not a black frame | luma=0.965 1440x900 bytes=137167 |
...
| shot:route.png | PASS | screenshot route.png is not a black frame | luma=0.959 1440x900 bytes=120460 |
...
| shot:lens.png | PASS | screenshot lens.png is not a black frame | luma=0.956 1440x900 bytes=123242 |
...
| shot:python-desk.png | PASS | screenshot python-desk.png is not a black frame | luma=0.962 1440x900 bytes=99558 |
...
| shot:ts-desk.png | PASS | screenshot ts-desk.png is not a black frame | luma=0.962 1440x900 bytes=99399 |
