...
| G2 | PASS | self-review graph has nodes, edges, and files | nodes=2473 edges=13782 files=58 |
| G3 | PASS | self-review graph includes Rust files | rs=374 |
| G4 | PASS | self-review Map altitude is a real community cut, not a lone START | bubbles=3620 altitude=304 names=crate::crates::graphide-cli::src::main::ProgressSink::new,crate::crates::graphide-cli::src::main::Cli,crate::crates::graphide-cli::src::main::Cmd,crate::crates::graphide-cli::src::main::ProgressSink,crate::crates::graphide-engine::src::cluster::cluster_with,crate::crates::graphide-engine::src::cluster::coarse_bubbles,crate::crates::graphide-engine::src::cluster::node_coarse_bubble,crate::crates::graphide-engine::src::coverage::changed_nodes_with_sources |
| G5 | PASS | self-review snapshot is this checkout, not the synthetic explorer fixture | nodes=2473 edges=13782 |
...
| shot:overview.png | PASS | screenshot overview.png is not a black frame | luma=0.958 1440x900 bytes=122574 |
...
| X3 | PASS | Export SVG was saved | bytes=110776 |
...
| shot:preset-blueprint.png | PASS | screenshot preset-blueprint.png is not a black frame | luma=0.923 1440x900 bytes=156186 |
...
| shot:evidence.png | PASS | screenshot evidence.png is not a black frame | luma=0.963 1440x900 bytes=149065 |
...
| shot:stamp-host.png | PASS | screenshot stamp-host.png is not a black frame | luma=0.964 1440x900 bytes=155496 |
| R1 | PASS | self-review desk loaded the derived snapshot (not synthetic fallback) | 2473 nodes · 13782 edges · 58 files · 76756ms · javascript@0.1.0,python@0.1.0,rust@0.1.0,typescript@0.1.0 |
| R2 | PASS | self-review desk mode is on after live snap | {"desk":true,"bright":true,"status":"2473 nodes · 13782 edges · 58 files · 76756ms · javascript@0.1.0,python@0.1.0,ru"} |
| R3 | PASS | self-review chrome shows this checkout's graph counts | 2473 nodes · 13782 edges · 58 files · 76756ms · javascript@0.1.0,python@0.1.0,rust@0.1.0,typescript@0.1.0 |
...
| shot:self-review.png | PASS | screenshot self-review.png is not a black frame | luma=0.962 1440x900 bytes=168273 |
...
| shot:delta.png | PASS | screenshot delta.png is not a black frame | luma=0.961 1440x900 bytes=86769 |
...
| shot:sequence.png | PASS | screenshot sequence.png is not a black frame | luma=0.958 1440x900 bytes=111710 |
...
| F3 | PASS | Data-flow path has a Source and a Sink | roles=store,sink,source eventsEndpoint · Sink · Channel \| subscribeFunction \| publishFunction |
| F4 | PASS | Data-flow has an ordered hop list | hops=2 kinds=Subscribes,Publishes |
| F5 | PASS | Data-flow lists subscribe / publish / events on the demo slice | eventsEndpoint · Sink · Channel \| subscribeFunction \| publishFunction \| Subscribesevents → subscribecrate::bus::events · src/sub.rs |
...
| shot:dataflow.png | PASS | screenshot dataflow.png is not a black frame | luma=0.960 1440x900 bytes=129413 |
...
| L3 | PASS | Lifecycle has proposed / walking / broken states | types=start,active,waiting,success,neutral,failure Proposedstart \| Walkingactive · 1 hop \| Waitingwaiting · stamp / skip |
| L4 | PASS | Lifecycle has an ordered event list | events=6 |
| L5 | PASS | Lifecycle recover is broken → walking (and lists events) | Proposedstart \| Walkingactive · 1 hop \| Waitingwaiting · stamp / skip \| Stampedsuccess |
...
| shot:lifecycle.png | PASS | screenshot lifecycle.png is not a black frame | luma=0.962 1440x900 bytes=119602 |
...
| shot:route.png | PASS | screenshot route.png is not a black frame | luma=0.956 1440x900 bytes=119923 |
...
| shot:lens.png | PASS | screenshot lens.png is not a black frame | luma=0.954 1440x900 bytes=128981 |
