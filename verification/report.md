...
| G2 | PASS | self-review graph has nodes, edges, and files | nodes=2739 edges=16216 files=68 |
| G3 | PASS | self-review graph includes Rust files | rs=395 |
| G4 | PASS | self-review Map altitude is a real community cut, not a lone START | bubbles=4058 altitude=349 names=fixtures.ts.pkg.bus.Bus.publish,fixtures.js.pkg.bus.BroadcastChannel,fixtures.js.pkg.bus.Bus.publish,fixtures.js.pkg.bus.Bus,fixtures.python.pkg.bus.BroadcastChannel,fixtures.python.pkg.bus.Bus.publish,fixtures.python.pkg.bus.Bus,fixtures.python.pkg.bus.publish |
| G5 | PASS | self-review snapshot is this checkout, not the synthetic explorer fixture | nodes=2739 edges=16216 |
...
| shot:overview.png | PASS | screenshot overview.png is not a black frame | luma=0.965 1440x900 bytes=115765 |
...
| shot:decisions.png | PASS | screenshot decisions.png is not a black frame | luma=0.955 1440x900 bytes=114679 |
...
| shot:unmatched-hint.png | PASS | screenshot unmatched-hint.png is not a black frame | luma=0.959 1440x900 bytes=120170 |
...
| shot:open-slice.png | PASS | screenshot open-slice.png is not a black frame | luma=0.967 1440x900 bytes=130066 |
...
| shot:registry.png | PASS | screenshot registry.png is not a black frame | luma=0.948 1440x900 bytes=89174 |
...
| shot:timeline.png | PASS | screenshot timeline.png is not a black frame | luma=0.956 1440x900 bytes=98846 |
...
| shot:uncovered-node.png | PASS | screenshot uncovered-node.png is not a black frame | luma=0.961 1440x900 bytes=105826 |
...
| shot:draft-hint.png | PASS | screenshot draft-hint.png is not a black frame | luma=0.961 1440x900 bytes=109136 |
...
| shot:map.png | PASS | screenshot map.png is not a black frame | luma=0.964 1440x900 bytes=169183 |
...
| AC3 | PASS | .workspaces is a pill rack with tinted Map .on | {"wsRadius":14,"mapOn":true,"tinted":true,"onBg":"rgba(0, 122, 255, 0.14)","onColor":"rgb(0, 122, 255)"} |
...
| shot:apple-chrome.png | PASS | screenshot apple-chrome.png is not a black frame | luma=0.964 1440x900 bytes=171646 |
...
| shot:apple-chrome-icons.png | PASS | screenshot apple-chrome-icons.png is not a black frame | luma=0.964 1440x900 bytes=171646 |
...
| shot:fit-reorg.png | PASS | screenshot fit-reorg.png is not a black frame | luma=0.964 1440x900 bytes=174098 |
...
| shot:zoom.png | PASS | screenshot zoom.png is not a black frame | luma=0.963 1440x900 bytes=177056 |
...
| RC2 | PASS | Preview / patch recycles Map stage and keeps the camera | {"sameStage":true,"sameVp":true,"cards":12,"xy":0,"comm":0,"lod":"0","k":0.6327888644090888,"stampPosts":0,"skipPosts":0,"ws":"map"} |
| RC3 | PASS | Recycle does not post stamp / skip | {"stampPosts":0,"skipPosts":0} |
| shot:canvas-recycle.png | PASS | screenshot canvas-recycle.png is not a black frame | luma=0.960 1440x900 bytes=169513 |
| RC4 | PASS | Canvas recycle did not write .graphide/stamps/ | absent |
| DA0 | PASS | Map paints communities before a coverage-only patch | {"cards":12,"xy":0,"comm":0,"lod":"0","k":0.6295377182592384,"cov":"2 left0 stamped1 skipped1 brokenCoverage 1123 changed · 1123 uncovered · Review 0 stamped · 1 skipped · 1 broken · 2 pending · e.g. ScreenshotFormat, ext, as_str +1120stamp broken boot · +1 / −0unmatched solarsim::MissingHit in boot0%Coverage67%Health3Open","ws":"map"} |
| DA1 | PASS | Coverage/findings-only patch keeps the same .stage / .viewport and camera | {"sameStage":true,"sameVp":true,"cards":12,"xy":0,"comm":0,"lod":"0","k":0.6292372881355932,"wantK":0.6292372881355932,"cov":"2 left0 stamped1 skipped1 brokenCoverage 1 changed · 3 uncovered · Review 0 stamped · 1 skipped · 1 broken · 2 pending · e.g. Body, SelectedEntity, PilotModeunmatched solarsim::MissingHit in bootunmatched graphide::OnAnalysisDelta in boot0%","stampPosts":0,"skipPosts":0,"ws":"map"} |
| DA2 | PASS | Coverage-only patch updates #coverage without posting stamp / skip | {"cov":"2 left0 stamped1 skipped1 brokenCoverage 1 changed · 3 uncovered · Review 0 stamped · 1 skipped · 1 broken · 2 pending · e.g. Body, SelectedEntity, PilotModeunmatched solarsim::MissingHit in bootunmatched graphide::OnAnalysisDelta in boot0%","stampPosts":0,"skipPosts":0} |
| shot:delta-onanalysis.png | PASS | screenshot delta-onanalysis.png is not a black frame | luma=0.964 1440x900 bytes=171648 |
...
| shot:map-offview.png | PASS | screenshot map-offview.png is not a black frame | luma=0.962 1440x900 bytes=179410 |
...
| PT1 | PASS | Fat panel patch keeps the same .stage / .viewport and sheds findings expansion | {"sameStage":true,"sameVp":true,"cards":12,"xy":0,"comm":0,"lod":"0","shed":"shed","findings":0,"cov":"2 left0 stamped1 skipped1 brokenCoverage 80 changed · 80 uncovered · Review 0 stamped · 1 skipped · 1 broken · 2 pending0%Coverage67%Health3Open","hasTimeout":false,"stampPosts":0,"skipPosts":0,"ws":"map"} |
| shot:panel-timeout.png | PASS | screenshot panel-timeout.png is not a black frame | luma=0.964 1440x900 bytes=165451 |
...
| shot:flow-tabs.png | PASS | screenshot flow-tabs.png is not a black frame | luma=0.967 1440x900 bytes=132678 |
...
| shot:slice-grey.png | PASS | screenshot slice-grey.png is not a black frame | luma=0.966 1440x900 bytes=131567 |
...
| shot:slice-runs.png | PASS | screenshot slice-runs.png is not a black frame | luma=0.967 1440x900 bytes=131675 |
...
| SE0 | PASS | Slice paints Steiner XYFlow before recycle | {"ws":"slice","slice":29,"enter":0,"cards":0,"k":0.4434332404497321} |
| SE1 | PASS | Re-select Slice recycles the same .stage / .viewport (keepCam) | {"sameStage":true,"sameVp":true,"slice":29,"enter":0,"k":0.5210526315789473,"wantK":0.5208088192462912,"ws":"slice"} |
| SE2 | PASS | Patch recycles Slice stage and keeps the camera | {"sameStage":true,"sameVp":true,"slice":29,"k":0.5210526315789473,"wantK":0.5208088192462912,"ws":"slice"} |
...
| shot:slice-enter-recycle.png | PASS | screenshot slice-enter-recycle.png is not a black frame | luma=0.967 1440x900 bytes=146828 |
...
| shot:stamp-recheck.png | PASS | screenshot stamp-recheck.png is not a black frame | luma=0.968 1440x900 bytes=129000 |
...
| shot:progress.png | PASS | screenshot progress.png is not a black frame | luma=0.959 1440x900 bytes=168275 |
...
| shot:cancel-review.png | PASS | screenshot cancel-review.png is not a black frame | luma=0.963 1440x900 bytes=167554 |
...
| shot:night.png | PASS | screenshot night.png is not a black frame | luma=0.148 std=0.118 1440x900 bytes=188657 |
| N3 | PASS | Night Map is dark vs day map.png | night=0.148 day=0.964 std=0.118 |
| N4 | PASS | Night does not post a stamp | {"stampPosts":0,"skipPosts":0,"appearance":1} |
| WH0 | PASS | Night explorer Map is WHOOP cool near-black (#101518) | {"htmlNight":true,"bodyNight":true,"nightOn":true,"ws":"map","pageBg":[16,21,24],"pageLuma":0.079} |
| WH1 | PASS | #coverage leads with three equal dials: Coverage / Health / Open | {"keys":["coverage","health","open"],"first":true,"display":"flex","shown":[true,true,true],"widths":[76,76,76]} |
| WH2 | PASS | Dial arcs are thick round rings in WHOOP colors | [{"key":"health","tone":"green","cap":"round","w":4.2,"stroke":"rgb(22, 236, 6)"},{"key":"open","tone":"","cap":"round","w":4.2,"stroke":"rgb(0, 147, 231)"}] |
| WH3 | PASS | Dial numbers are big white type | [{"key":"coverage","color":"rgb(255, 255, 255)","px":18,"weight":700},{"key":"health","color":"rgb(255, 255, 255)","px":18,"weight":700},{"key":"open","color":"rgb(255, 255, 255)","px":18,"weight":700}] |
| WH4 | PASS | Dial labels are UPPERCASE tracked Coverage / Health / Open | [{"label":"Coverage","transform":"uppercase","tracking":1.4},{"label":"Health","transform":"uppercase","tracking":1.4},{"label":"Open","transform":"uppercase","tracking":1.4}] |
| WH5 | PASS | Dial values match the #coverage caption; .score is hidden on Night | {"coverage":true,"health":true,"open":true,"scoreHidden":true,"caption":"Coverage 1123 changed · 1123 uncovered · Review 0 stamped · 1 skipped · 1 broken · 2 pending · e.g. ScreenshotFormat, ex","review":[0,1,1,2],"values":["coverage=0%","health=67%@67:green","open=3@100"],"score":"none"} |
| WH6 | PASS | Night Map cards are raised soft neutral surfaces; chrome does not leak Day white | {"cards":12,"shown":12,"ok":12,"card":{"ok":true,"r":18,"layers":3,"blur":32,"neutral":true,"tile":true,"fill":"linear-gradient(rgb(36, 44, 50), rgb(28, 35, 40))"},"leakSeen":{"#tabs .tab":3,".kind-pill":3,".leg":1,".feat-chip":8,"#storyRail":1,".stage > .flow-title":1},"leaks":[]} |
| WH7 | PASS | WHOOP chrome keeps Map community LOD (xy=0) | xy=0 lod0=true cards=12 |
| shot:whoop-health-night.png | PASS | screenshot whoop-health-night.png is not a black frame | luma=0.137 std=0.073 1440x900 bytes=188767 |
| WH8 | PASS | WHOOP night step did not post stamp / skip | {"stampPosts":0,"skipPosts":0} |
| WH9 | PASS | WHOOP night step did not write .graphide/stamps/ | absent |
...
| WH10 | PASS | Day hides #coverage .dials and keeps the .score row | {"dials":"none","score":"flex","scoreShown":true} |
...
| shot:enter-bubble.png | PASS | screenshot enter-bubble.png is not a black frame | luma=0.967 1440x900 bytes=147413 |
...
| shot:ego.png | PASS | screenshot ego.png is not a black frame | luma=0.963 1440x900 bytes=181328 |
...
| shot:search.png | PASS | screenshot search.png is not a black frame | luma=0.963 1440x900 bytes=181316 |
...
| shot:kind-filters.png | PASS | screenshot kind-filters.png is not a black frame | luma=0.967 1440x900 bytes=149104 |
...
| shot:ask.png | PASS | screenshot ask.png is not a black frame | luma=0.953 1440x900 bytes=176000 |
...
| shot:keys.png | PASS | screenshot keys.png is not a black frame | luma=0.965 1440x900 bytes=172403 |
...
| shot:path-walk.png | PASS | screenshot path-walk.png is not a black frame | luma=0.967 1440x900 bytes=172151 |
...
| X2 | PASS | Export PNG was saved and is not a black frame | luma=0.945 std=0.053 1888x520 bytes=91734 |
| X3 | PASS | Export SVG was saved | bytes=134159 |
...
| shot:preset-blueprint.png | PASS | screenshot preset-blueprint.png is not a black frame | luma=0.938 1440x900 bytes=178254 |
...
| shot:present.png | PASS | screenshot present.png is not a black frame | luma=0.925 1440x900 bytes=77090 |
...
| shot:evidence.png | PASS | screenshot evidence.png is not a black frame | luma=0.965 1440x900 bytes=158780 |
...
| shot:coverage-mark.png | PASS | screenshot coverage-mark.png is not a black frame | luma=0.967 1440x900 bytes=152545 |
...
| shot:hop-card.png | PASS | screenshot hop-card.png is not a black frame | luma=0.967 1440x900 bytes=158514 |
...
| shot:stamp-host.png | PASS | screenshot stamp-host.png is not a black frame | luma=0.965 1440x900 bytes=163872 |
| R1 | PASS | self-review desk loaded the derived snapshot (not synthetic fallback) | 2739 nodes · 16216 edges · 68 files · 94482ms · javascript@0.1.0,python@0.1.0,rust@0.1.0,typescript@0.1.0 |
| R2 | PASS | self-review desk mode is on after live snap | {"desk":true,"bright":true,"status":"2739 nodes · 16216 edges · 68 files · 94482ms · javascript@0.1.0,python@0.1.0,ru"} |
| R3 | PASS | self-review chrome shows this checkout's graph counts | 2739 nodes · 16216 edges · 68 files · 94482ms · javascript@0.1.0,python@0.1.0,rust@0.1.0,typescript@0.1.0 |
...
| shot:self-review.png | PASS | screenshot self-review.png is not a black frame | luma=0.968 1440x900 bytes=171481 |
...
| shot:program-chips.png | PASS | screenshot program-chips.png is not a black frame | luma=0.968 1440x900 bytes=171832 |
...
| shot:all-programs.png | PASS | screenshot all-programs.png is not a black frame | luma=0.968 1440x900 bytes=171489 |
...
| D3 | PASS | Delta fact list is not empty on demo vs demo-parent | facts=6 kinds=stable,stable,stable,stable,added,added |
| D4 | PASS | Delta lists added crate::bus::sneaky_helper | = stablecommunity · bubble 1 · crate::sub::decodekept bubble 1 \| = stablecommunity · bubble 2 · crate::bus::flushkept bubble 2 \| = stablecommunity · bubble 3 · crate::bus::BroadcastChannelkept bubble 3 \| = stablecommunity · bubble 4 · crate::bus::eventskept bubble 4 |
...
| shot:delta.png | PASS | screenshot delta.png is not a black frame | luma=0.966 1440x900 bytes=111057 |
...
| SC1 | PASS | Delta paints a community fact with the sticky BubbleId | {"community":5,"sticky":4,"kinds":["stable","stable","stable","stable","added"],"bubbles":["1","2","3","4"],"text":"= stablecommunity · bubble 1 · crate::sub::decodekept bubble 1","id":"1"} |
| SC2 | PASS | Sticky cluster fact names the kept bubble id | = stablecommunity · bubble 1 · crate::sub::decodekept bubble 1 |
| shot:sticky-clusters.png | PASS | screenshot sticky-clusters.png is not a black frame | luma=0.967 1440x900 bytes=101128 |
...
| shot:delta-sticky-views.png | PASS | screenshot delta-sticky-views.png is not a black frame | luma=0.967 1440x900 bytes=101125 |
...
| shot:proposed-uncovered.png | PASS | screenshot proposed-uncovered.png is not a black frame | luma=0.972 1440x900 bytes=101596 |
...
| shot:sequence.png | PASS | screenshot sequence.png is not a black frame | luma=0.963 1440x900 bytes=106650 |
...
| shot:flow-hints.png | PASS | screenshot flow-hints.png is not a black frame | luma=0.966 1440x900 bytes=92589 |
...
| shot:dataflow.png | PASS | screenshot dataflow.png is not a black frame | luma=0.963 1440x900 bytes=125125 |
...
| shot:lifecycle.png | PASS | screenshot lifecycle.png is not a black frame | luma=0.960 1440x900 bytes=118171 |
...
| shot:lineage.png | PASS | screenshot lineage.png is not a black frame | luma=0.969 1440x900 bytes=130549 |
...
| shot:route.png | PASS | screenshot route.png is not a black frame | luma=0.961 1440x900 bytes=114345 |
...
| shot:lens.png | PASS | screenshot lens.png is not a black frame | luma=0.958 1440x900 bytes=117163 |
...
| shot:python-desk.png | PASS | screenshot python-desk.png is not a black frame | luma=0.966 1440x900 bytes=93228 |
...
| shot:js-desk.png | PASS | screenshot js-desk.png is not a black frame | luma=0.966 1440x900 bytes=93169 |
...
| shot:ts-desk.png | PASS | screenshot ts-desk.png is not a black frame | luma=0.966 1440x900 bytes=93012 |
