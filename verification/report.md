...
| HD2 | PASS | A live review adds a working row and leaves boot blocked | {"name":"review","boot":"blocked"} |
| HD3 | PASS | Blocked herd row opens the pending UnmatchedHint decision | {"ws":"decisions","title":"UnmatchedHint · boot · MissingHit","outcome":"pending","xy":0} |
| shot:herd-rail.png | PASS | screenshot herd-rail.png is not a black frame | luma=0.958 1440x900 bytes=123265 |
| HD4 | PASS | Herd jump did not post stamp | {"stampPosts":0} |
| HD5 | PASS | Herd step did not write .graphide/stamps/ | absent |
...
| shot:open-slice.png | PASS | screenshot open-slice.png is not a black frame | luma=0.968 1440x900 bytes=133375 |
...
| shot:registry.png | PASS | screenshot registry.png is not a black frame | luma=0.949 1440x900 bytes=93974 |
...
| shot:timeline.png | PASS | screenshot timeline.png is not a black frame | luma=0.955 1440x900 bytes=102679 |
...
| shot:draft-hint.png | PASS | screenshot draft-hint.png is not a black frame | luma=0.961 1440x900 bytes=112430 |
...
| DA2 | PASS | Coverage-only patch updates #coverage without posting stamp / skip | {"cov":"2 left0 stamped1 skipped1 brokenCoverage 1 changed · 3 uncovered · Review 0 stamped · 1 skipped · 1 broken · 2 pending · e.g. Body, SelectedEntity, PilotModeunmatched solarsim::MissingHit in bootunmatched graphide::OnAnalysisDelta in bootov","stampPosts":0,"skipPosts":0} |
| shot:delta-onanalysis.png | PASS | screenshot delta-onanalysis.png is not a black frame | luma=0.963 1440x900 bytes=172302 |
...
| shot:map-offview.png | PASS | screenshot map-offview.png is not a black frame | luma=0.962 1440x900 bytes=182457 |
...
| PT1 | PASS | Fat panel patch keeps the same .stage / .viewport and sheds findings expansion | {"sameStage":true,"sameVp":true,"cards":12,"xy":0,"comm":0,"lod":"0","shed":"shed","findings":0,"cov":"2 left0 stamped1 skipped1 brokenCoverage 80 changed · 80 uncovered · Review 0 stamped · 1 skipped · 1 broken · 2 pendingoverview · idlecontrol-flow · idleboot · blockedlegacy · done","hasTimeout":false,"stampPosts":0,"skipPosts":0,"ws":"map"} |
| shot:panel-timeout.png | PASS | screenshot panel-timeout.png is not a black frame | luma=0.964 1440x900 bytes=168765 |
...
| shot:ego.png | PASS | screenshot ego.png is not a black frame | luma=0.963 1440x900 bytes=182053 |
...
| shot:search.png | PASS | screenshot search.png is not a black frame | luma=0.963 1440x900 bytes=182039 |
...
| X3 | PASS | Export SVG was saved | bytes=132782 |
...
| shot:preset-blueprint.png | PASS | screenshot preset-blueprint.png is not a black frame | luma=0.940 1440x900 bytes=180675 |
...
| shot:present.png | PASS | screenshot present.png is not a black frame | luma=0.925 1440x900 bytes=77200 |
...
| shot:delta.png | PASS | screenshot delta.png is not a black frame | luma=0.966 1440x900 bytes=114319 |
...
| shot:sticky-clusters.png | PASS | screenshot sticky-clusters.png is not a black frame | luma=0.967 1440x900 bytes=104464 |
...
| shot:delta-sticky-views.png | PASS | screenshot delta-sticky-views.png is not a black frame | luma=0.967 1440x900 bytes=104509 |
...
| shot:proposed-uncovered.png | PASS | screenshot proposed-uncovered.png is not a black frame | luma=0.972 1440x900 bytes=104971 |
...
| shot:sequence.png | PASS | screenshot sequence.png is not a black frame | luma=0.964 1440x900 bytes=108803 |
...
| shot:flow-hints.png | PASS | screenshot flow-hints.png is not a black frame | luma=0.966 1440x900 bytes=94479 |
...
| shot:dataflow.png | PASS | screenshot dataflow.png is not a black frame | luma=0.963 1440x900 bytes=126961 |
...
| shot:lifecycle.png | PASS | screenshot lifecycle.png is not a black frame | luma=0.961 1440x900 bytes=119967 |
...
| shot:route.png | PASS | screenshot route.png is not a black frame | luma=0.961 1440x900 bytes=116384 |
...
| shot:lens.png | PASS | screenshot lens.png is not a black frame | luma=0.958 1440x900 bytes=119299 |
...
| shot:python-desk.png | PASS | screenshot python-desk.png is not a black frame | luma=0.966 1440x900 bytes=95198 |
