...
| G2 | PASS | self-review graph has nodes, edges, and files | nodes=2729 edges=16130 files=68 |
| G3 | PASS | self-review graph includes Rust files | rs=395 |
| G4 | PASS | self-review Map altitude is a real community cut, not a lone START | bubbles=4071 altitude=345 names=fixtures.ts.pkg.bus.Bus.publish,fixtures.js.pkg.bus.BroadcastChannel,fixtures.js.pkg.bus.Bus.publish,fixtures.js.pkg.bus.Bus,fixtures.python.pkg.bus.BroadcastChannel,fixtures.python.pkg.bus.Bus.publish,fixtures.python.pkg.bus.Bus,fixtures.python.pkg.bus.publish |
| G5 | PASS | self-review snapshot is this checkout, not the synthetic explorer fixture | nodes=2729 edges=16130 |
...
| shot:overview.png | PASS | screenshot overview.png is not a black frame | luma=0.964 1440x900 bytes=114239 |
...
| shot:decisions.png | PASS | screenshot decisions.png is not a black frame | luma=0.955 1440x900 bytes=113207 |
...
| shot:unmatched-hint.png | PASS | screenshot unmatched-hint.png is not a black frame | luma=0.959 1440x900 bytes=118445 |
...
| shot:open-slice.png | PASS | screenshot open-slice.png is not a black frame | luma=0.967 1440x900 bytes=128362 |
...
| shot:registry.png | PASS | screenshot registry.png is not a black frame | luma=0.948 1440x900 bytes=87626 |
...
| shot:timeline.png | PASS | screenshot timeline.png is not a black frame | luma=0.954 1440x900 bytes=97188 |
...
| shot:uncovered-node.png | PASS | screenshot uncovered-node.png is not a black frame | luma=0.961 1440x900 bytes=104387 |
...
| shot:draft-hint.png | PASS | screenshot draft-hint.png is not a black frame | luma=0.961 1440x900 bytes=107315 |
...
| shot:map.png | PASS | screenshot map.png is not a black frame | luma=0.963 1440x900 bytes=169247 |
...
| shot:apple-chrome.png | PASS | screenshot apple-chrome.png is not a black frame | luma=0.964 1440x900 bytes=170252 |
...
| shot:fit-reorg.png | PASS | screenshot fit-reorg.png is not a black frame | luma=0.963 1440x900 bytes=172712 |
...
| shot:zoom.png | PASS | screenshot zoom.png is not a black frame | luma=0.963 1440x900 bytes=178363 |
...
| shot:canvas-recycle.png | PASS | screenshot canvas-recycle.png is not a black frame | luma=0.960 1440x900 bytes=169108 |
...
| shot:delta-onanalysis.png | PASS | screenshot delta-onanalysis.png is not a black frame | luma=0.963 1440x900 bytes=170285 |
...
| shot:map-offview.png | PASS | screenshot map-offview.png is not a black frame | luma=0.961 1440x900 bytes=181158 |
...
| shot:panel-timeout.png | PASS | screenshot panel-timeout.png is not a black frame | luma=0.964 1440x900 bytes=165207 |
...
| shot:flow-tabs.png | PASS | screenshot flow-tabs.png is not a black frame | luma=0.967 1440x900 bytes=130460 |
...
| shot:slice-grey.png | PASS | screenshot slice-grey.png is not a black frame | luma=0.966 1440x900 bytes=130049 |
...
| shot:slice-runs.png | PASS | screenshot slice-runs.png is not a black frame | luma=0.966 1440x900 bytes=129951 |
...
| SE0 | PASS | Slice paints Steiner XYFlow before recycle | {"ws":"slice","slice":29,"enter":0,"cards":0,"k":0.4463456764920298} |
...
| shot:slice-enter-recycle.png | PASS | screenshot slice-enter-recycle.png is not a black frame | luma=0.966 1440x900 bytes=144947 |
...
| shot:stamp-recheck.png | PASS | screenshot stamp-recheck.png is not a black frame | luma=0.967 1440x900 bytes=127251 |
...
| shot:progress.png | PASS | screenshot progress.png is not a black frame | luma=0.959 1440x900 bytes=167206 |
...
| shot:cancel-review.png | PASS | screenshot cancel-review.png is not a black frame | luma=0.962 1440x900 bytes=168931 |
...
| shot:night.png | PASS | screenshot night.png is not a black frame | luma=0.228 std=0.245 1440x900 bytes=147863 |
| N3 | PASS | Night Map is dark vs day map.png | night=0.228 day=0.963 std=0.245 |
...
| shot:enter-bubble.png | PASS | screenshot enter-bubble.png is not a black frame | luma=0.967 1440x900 bytes=145637 |
...
| shot:ego.png | PASS | screenshot ego.png is not a black frame | luma=0.963 1440x900 bytes=179794 |
...
| shot:search.png | PASS | screenshot search.png is not a black frame | luma=0.963 1440x900 bytes=179774 |
...
| shot:kind-filters.png | PASS | screenshot kind-filters.png is not a black frame | luma=0.966 1440x900 bytes=147266 |
...
| shot:ask.png | PASS | screenshot ask.png is not a black frame | luma=0.953 1440x900 bytes=174693 |
...
| shot:keys.png | PASS | screenshot keys.png is not a black frame | luma=0.965 1440x900 bytes=172019 |
...
| shot:path-walk.png | PASS | screenshot path-walk.png is not a black frame | luma=0.964 1440x900 bytes=173155 |
...
| X2 | PASS | Export PNG was saved and is not a black frame | luma=0.944 std=0.056 1888x520 bytes=85695 |
| X3 | PASS | Export SVG was saved | bytes=126682 |
...
| shot:preset-blueprint.png | PASS | screenshot preset-blueprint.png is not a black frame | luma=0.938 1440x900 bytes=178612 |
...
| shot:present.png | PASS | screenshot present.png is not a black frame | luma=0.926 1440x900 bytes=74515 |
...
| shot:evidence.png | PASS | screenshot evidence.png is not a black frame | luma=0.965 1440x900 bytes=156707 |
...
| shot:coverage-mark.png | PASS | screenshot coverage-mark.png is not a black frame | luma=0.967 1440x900 bytes=150467 |
...
| shot:hop-card.png | PASS | screenshot hop-card.png is not a black frame | luma=0.966 1440x900 bytes=156844 |
...
| shot:stamp-host.png | PASS | screenshot stamp-host.png is not a black frame | luma=0.964 1440x900 bytes=159556 |
| R1 | PASS | self-review desk loaded the derived snapshot (not synthetic fallback) | 2729 nodes · 16130 edges · 68 files · 92974ms · javascript@0.1.0,python@0.1.0,rust@0.1.0,typescript@0.1.0 |
| R2 | PASS | self-review desk mode is on after live snap | {"desk":true,"bright":true,"status":"2729 nodes · 16130 edges · 68 files · 92974ms · javascript@0.1.0,python@0.1.0,ru"} |
| R3 | PASS | self-review chrome shows this checkout's graph counts | 2729 nodes · 16130 edges · 68 files · 92974ms · javascript@0.1.0,python@0.1.0,rust@0.1.0,typescript@0.1.0 |
...
| shot:self-review.png | PASS | screenshot self-review.png is not a black frame | luma=0.967 1440x900 bytes=171018 |
...
| shot:program-chips.png | PASS | screenshot program-chips.png is not a black frame | luma=0.967 1440x900 bytes=171340 |
...
| shot:all-programs.png | PASS | screenshot all-programs.png is not a black frame | luma=0.967 1440x900 bytes=170994 |
...
| shot:delta.png | PASS | screenshot delta.png is not a black frame | luma=0.966 1440x900 bytes=109453 |
...
| shot:sticky-clusters.png | PASS | screenshot sticky-clusters.png is not a black frame | luma=0.967 1440x900 bytes=99507 |
...
| shot:delta-sticky-views.png | PASS | screenshot delta-sticky-views.png is not a black frame | luma=0.967 1440x900 bytes=99501 |
...
| shot:proposed-uncovered.png | PASS | screenshot proposed-uncovered.png is not a black frame | luma=0.972 1440x900 bytes=99971 |
...
| shot:sequence.png | PASS | screenshot sequence.png is not a black frame | luma=0.963 1440x900 bytes=105169 |
...
| shot:flow-hints.png | PASS | screenshot flow-hints.png is not a black frame | luma=0.966 1440x900 bytes=91055 |
...
| shot:dataflow.png | PASS | screenshot dataflow.png is not a black frame | luma=0.963 1440x900 bytes=123501 |
...
| shot:lifecycle.png | PASS | screenshot lifecycle.png is not a black frame | luma=0.960 1440x900 bytes=116467 |
...
| shot:lineage.png | PASS | screenshot lineage.png is not a black frame | luma=0.968 1440x900 bytes=128982 |
...
| shot:route.png | PASS | screenshot route.png is not a black frame | luma=0.961 1440x900 bytes=112731 |
...
| shot:lens.png | PASS | screenshot lens.png is not a black frame | luma=0.958 1440x900 bytes=115514 |
...
| shot:python-desk.png | PASS | screenshot python-desk.png is not a black frame | luma=0.966 1440x900 bytes=91736 |
...
| shot:js-desk.png | PASS | screenshot js-desk.png is not a black frame | luma=0.966 1440x900 bytes=91626 |
...
| shot:ts-desk.png | PASS | screenshot ts-desk.png is not a black frame | luma=0.966 1440x900 bytes=91536 |
