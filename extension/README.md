...
Review any local repo as a flow graph. The panel is Apple-bright (iOS grouped cards, system blue) — live SolarSim caps live in the repo-root `UIUX_sample/` folder. Live installer caps live in the repo-root `install_sample/` folder.
